...
checkpoint_path_32 = 'checkpoints/four_layers_bilstm_without_data_augmentation_32.h5'
...
model_32 = load_model('checkpoints/four_layers_bilstm_without_data_augmentation_32.h5')
model_32.summary()
# Compile the models
...
history_32 = model_32.fit(X_train, y_train, epochs=1, batch_size=32, validation_data=(X_val, y_val), callbacks=[model_checkpoint_32, scheduler])
...
# model_32.save('two_layers_bilstm_32_fine_tune_data_segementation_without_ECS.h5')
...
plt.legend()
plt.title('Training and Validation Loss for Batch Sizes 32(BiLSTM)')
plt.grid(True)

# Save the plot
if not os.path.exists('plots'):
    os.makedirs('plots')
plt.savefig('plots/four_layers_bilstm_without_data_augmentation_32.png')
