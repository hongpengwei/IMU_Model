'''
python DANN_CORR_AE_reverse.py --training_source_domain_data D:\Experiment\data\\UM_DSI_DB_v1.0.0_lite\data\tony_data_reverse\2020-02-19\wireless_training.csv ^
                       ...
                       --work_dir 200219_190611\\unlabeled\0.1_2_2
python DANN_CORR_AE_reverse.py --test --work_dir 200219_190611\\unlabeled\0.1_2_2
'''
...
from DANN_CORR_reverse import HistCorrDANNModel, LabelPredictor, DomainAdaptationModel
import argparse
import numpy as np
import pandas as pd
...
class AutoencoderFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.encoder_fc1 = nn.Linear(191, 128)
        self.encoder_fc2 = nn.Linear(128, 64)
        self.decoder_fc1 = nn.Linear(64, 128)
        self.decoder_fc2 = nn.Linear(128, 191)
