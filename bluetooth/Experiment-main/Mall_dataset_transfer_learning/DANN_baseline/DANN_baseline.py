'''
python DANN_baseline.py --training_source_domain_data D:\Experiment\data\MTLocData\Mall\2021-11-20\wireless_training.csv ^
                --training_target_domain_data D:\Experiment\data\MTLocData\Mall\2022-12-21\wireless_training.csv ^
                --work_dir 211120_221221\0.1_0.1_10
python DANN_baseline.py --test --work_dir 211120_221221\0.1_0.1_10
'''
...
class DANNWithCAEAndPA(DANNWithCAE):
    ...
    def _run_epoch(self, data_loader, training=False, unlabeled=False):
        ...
        for _ in range(num_batches):
            ...
            if training:
                self.class_classifier.partial_fit(source_np_encoded, source_np_labels, np.arange(298))
                if not unlabeled:
                    self.class_classifier.partial_fit(target_np_encoded, target_np_labels, np.arange(298))
